...
1. **Chrome Web Store** (Recommended)
   - [Install WikiQuiz](YOUR_CHROME_STORE_LINK)
   - Click "Add to Chrome"
   - Click popup for usage guide

2. **Manual Installation** (For developers)
   ```bash
   git clone https://github.com/maksimyin/WikiQuiz.git 
   cd WikiQuiz
   npm install
   npm run build
   ```
...
- Wikipedia for providing this free and accessable knowledge to all
- All beta testers and early users for valuable feedback


## 💭 Feedback and Contributing

If you have the time, I would greatly appreciate your [feedback](https://form.jotform.com/253196240478159) to improve the quality of this extension. If you find any bugs, please report them [here](https://github.com/maksimyin/WikiQuiz/issues).